...
pub static CMD_GAT: Unsigned = Unsigned::new();
...
pub static CMD_TOUCH: Unsigned = Unsigned::new();
...
pub static GAT_HITS: Unsigned = Unsigned::new();
pub static GAT_MISSES: Unsigned = Unsigned::new();
...
pub static TOUCH_HITS: Unsigned = Unsigned::new();
pub static TOUCH_MISSES: Unsigned = Unsigned::new();
...
pub fn report(curr_items: usize) -> Vec<(&'static str, String)> {
    vec![
        ...
        ("gat_hits", GAT_HITS.value().as_u64().to_string()),
        ("gat_misses", GAT_MISSES.value().as_u64().to_string()),
        ...
        ("touch_hits", TOUCH_HITS.value().as_u64().to_string()),
        ("touch_misses", TOUCH_MISSES.value().as_u64().to_string()),
